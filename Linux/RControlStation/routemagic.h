...
public:
    ...
    static QList<LocPoint> fillConvexPolygonWithZigZag(QList<LocPoint> bounds, double spacing, double speed = 3.0/3.6, double speedInTurns = 2.0/3.6, int turnIntermediateSteps = 0, uint32_t setAttributesOnStraights = 0, double pointWithAttributesDistanceToTurn = 1.0);
    static QList<LocPoint> fillConvexPolygonWithFramedZigZag(QList<LocPoint> bounds, double spacing, double speed = 3.0/3.6, double speedInTurns = 2.0/3.6, int turnIntermediateSteps = 0, uint32_t setAttributesOnStraights = 0, double pointWithAttributesDistanceToTurn = 1.0);
