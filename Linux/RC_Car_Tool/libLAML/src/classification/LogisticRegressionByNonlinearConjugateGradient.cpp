/*
 * LogisticRegressionByNonlinearConjugateGradient.cpp
 *
 *  Created on: Feb 27, 2014
 *      Author: Mingjie Qian
 */

#include "LogisticRegressionByNonlinearConjugateGradient.h"
#include "Matrix.h"
...
LogisticRegressionByNonlinearConjugateGradient::LogisticRegressionByNonlinearConjugateGradient() {

}

LogisticRegressionByNonlinearConjugateGradient::LogisticRegressionByNonlinearConjugateGradient(double epsilon) {
	this->epsilon = epsilon;
}

void LogisticRegressionByNonlinearConjugateGradient::loadModel(std::string filePath) {

}

void LogisticRegressionByNonlinearConjugateGradient::saveModel(std::string filePath) {
...
Matrix& LogisticRegressionByNonlinearConjugateGradient::predictLabelScoreMatrix(Matrix& Xt) {
...
void LogisticRegressionByNonlinearConjugateGradient::computeGradient(Matrix& res, Matrix& A, Matrix& B) {
...
void LogisticRegressionByNonlinearConjugateGradient::computeActivation(Matrix& A, Matrix& X, Matrix& W) {
	double** AData = ((DenseMatrix&) A).getData();
	double* ARow = null;
