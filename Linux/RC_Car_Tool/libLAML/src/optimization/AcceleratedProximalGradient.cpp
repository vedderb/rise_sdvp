/*
 * AcceleratedProximalGradient.cpp
 *
 *  Created on: Feb 25, 2014
 *      Author: Mingjie Qian
 */

#include "AcceleratedProximalGradient.h"
#include "Utility.h"
...
Matrix* AcceleratedProximalGradient::Grad_Y_k = null;

Matrix* AcceleratedProximalGradient::X = null;

Matrix* AcceleratedProximalGradient::X_pre = null;

Matrix* AcceleratedProximalGradient::Y = null;

Matrix* AcceleratedProximalGradient::G_Y_k = null;

double AcceleratedProximalGradient::gval_Y_k = 0;

double AcceleratedProximalGradient::hval_Y_k = 0;

double AcceleratedProximalGradient::fval_Y_k = 0;

bool AcceleratedProximalGradient::gradientRequired = false;

bool AcceleratedProximalGradient::converge = false;

int AcceleratedProximalGradient::state = 0;

double AcceleratedProximalGradient::t = 1;

double AcceleratedProximalGradient::beta = 0.95;

int AcceleratedProximalGradient::k = 1;

double AcceleratedProximalGradient::xi = 1;

Matrix* AcceleratedProximalGradient::T = null;

int AcceleratedProximalGradient::type = 0;

std::list<double> AcceleratedProximalGradient::J;

ProximalMapping* AcceleratedProximalGradient::prox = null;

AcceleratedProximalGradient::~AcceleratedProximalGradient() {
	if (prox != null)
		delete prox;
	prox = null;
	delete X;
 ...
 *
 */
void AcceleratedProximalGradient::run(Matrix& Grad_t, double gval_t, double hval_t, double epsilon, Matrix& X_t, bool* res) {
