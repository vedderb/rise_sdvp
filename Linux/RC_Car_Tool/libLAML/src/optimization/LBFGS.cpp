...
Matrix* LBFGS::G_pre = NULL;

Matrix* LBFGS::X = NULL;

Matrix* LBFGS::X_pre = NULL;

Matrix* LBFGS::p = NULL;

double LBFGS::fval = 0;

bool LBFGS::gradientRequired = false;

bool LBFGS::converge = false;
...
double LBFGS::alpha = 0.2;

double LBFGS::beta = 0.75;

int LBFGS::m = 30;

double LBFGS::H = 0;

Matrix* LBFGS::s_k = NULL;

Matrix* LBFGS::y_k = NULL;

double LBFGS::rou_k = 0;

std::list<Matrix*> LBFGS::s_ks;
std::list<Matrix*> LBFGS::y_ks;
std::list<double> LBFGS::rou_ks;
std::list<double> LBFGS::J;

void LBFGS::run(Matrix& Grad_t, double fval_t, double epsilon, Matrix& X_t, bool* res) {
